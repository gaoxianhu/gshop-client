            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isActive('1')}" @click="setOrder('1')">
                  <a href="javascript:;">综合<i class="iconfont" v-if="isActive('1')" :class="iconClass"></i></a>
                </li>
                <li>
                  <a href="#">销量</a>
                </li>
                ...
                <li :class="{active: isActive('2')}" @click="setOrder('2')">
                  <a href="javascript:;">价格<i class="iconfont" v-if="isActive('2')" :class="iconClass"></i></a>
                </li>
                <!-- <li>
                  <a href="#">价格⬇</a>
                </li> -->
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="item in productList.goodsList" :key="item.id">
                <div class="list-wrap">
                  ...
                  <div class="operate">
                    <a href="success-cart.html" target="_blank" class="sui-btn btn-bordered btn-danger" @click="addToCart(item)">加入购物车</a>
